...
class SQLTransformer(Transformer):
    ...
    def type_int(self, _): return DataType.INTEGER
    def type_text(self, _): return DataType.TEXT
    def type_bool(self, _): return DataType.BOOLEAN
    def type_float(self, _): return DataType.FLOAT

    # Constraint mapping methods
    def pk(self, _): return "pk"
    def unique(self, _): return "unique"
    def not_null(self, _): return "not_null"
    ...
    def int(self, items): return int(items[0])
    def string(self, items): return str(items[0][1:-1])
    def float(self, items): return float(items[0])
